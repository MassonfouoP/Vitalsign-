...
if st.session_state.page == "accueil":
    ...
    if len(set(y_class)) >= 2 and len(X_train) >= 3:
        knn = KNeighborsClassifier(n_neighbors=min(2, len(X_train)-1))
        ...
        st.write("Pas assez de donnees variees pour la classification K-NN.")
